...
const KNOWN_ENV_NAME_PATTERN = /\b(?:OPENAI_API_KEY|ANTHROPIC_API_KEY|ANTHROPIC_AUTH_TOKEN|CF_API_TOKEN|CLOUDFLARE_API_TOKEN|CLOUDFLARE_API_TOKEN_INITIAL|Cloudflare_API|CLOUDFLARE_EMAIL|Global_API_Key|Gemini_API_KEY|Jules_API_Key|HF_API_Token|BROWSERLESS_TOKEN|CONTEXT7_API_KEY|ANTIGRAVITY_API_KEY|dbos_api_key|SPB_Access_Token|ACTION_API_KEY|ACTION_BEARER_TOKEN|github_codex_api|codex_cloudflare|nvapi)\b/gi;
