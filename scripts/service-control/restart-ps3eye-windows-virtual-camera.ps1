...
$summary = if ($parsed.ok) {
  "PS3 Eye virtual camera repair succeeded."
} else {
  "PS3 Eye repair ran but doctor still fails: " + ($failedChecks -join ", ")
}
