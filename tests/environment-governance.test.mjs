...
test("dashboard renders canonical DevGov registry state", async () => {
  ...
  assert.match(html, /--prediction-intake-column: 281px/);
  assert.match(html, /--prediction-intake-margin-bottom: 10px/);
  assert.match(html, /--prediction-outcome-column: 306px/);
  assert.match(html, /--prediction-outcome-step-offset: 14px/);
  assert.match(html, /--prediction-outcome-step-min-height: 90px/);
